  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      if (currentUser && !currentUser.email_confirmed_at) {
        ...
        Alert.alert(
          'Verify Your Email',
          'Please check your email and click the verification link to complete your registration. You can sign in after verification.',
          [
            {
              text: 'OK',
        ...
        // No verification needed or already verified, go to onboarding
      ...
      <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false}>
        ...
        <View className="gap-4">
          ...
          <View>
            ...
            <TextInput
              className={`border bg-gray-50 ${errors.name ? 'border-red-500' : 'border-gray-200'} rounded-xl px-4 py-3 text-base`}
          ...
          <View>
            ...
            <TextInput
              className={`border bg-gray-50 ${errors.confirmPassword ? 'border-red-500' : 'border-gray-200'} rounded-xl px-4 py-3 text-base`}
